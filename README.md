...
- 💬 リアルタイムチャット（報告フィード）
- 🗂️ チャンネル分け（地域・チーム別に報告を整理・その場で新規作成）
- 📋 報告テンプレート（訪問報告・商談進捗・日報・対応報告をワンタップ入力）
- 😊 リアクション（👍✅🎉💪 で報告に反応）
...
2. ログインすると報告フィードが表示されます
3. 上部のチャンネルバーで報告先を選択（＋ボタンでチャンネルを新規作成）
4. 📋 ボタンで報告テンプレート（訪問報告・日報など）を呼び出して入力
5. 📷 ボタンで写真を添付し、テキストと一緒に「送信」
6. 投稿はリアルタイムで全員に反映されます（画像はタップで拡大）
7. 各報告の ＋ ボタンから 👍✅🎉💪 のリアクションを付けられます
